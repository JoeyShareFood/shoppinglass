        ...
        <section id="content" class="p-1">
            <div class="inside1">
                    ...
                    <h3><?=utf8_decode(" O que você quer fazer agora")?> </h3>
						<a  style="color:#00C" target="_blank" href="<?=$INI['system']['wwwprefix']?>/"><img src="../skin/padrao/icones/Places-user-home-icon.png"  title="Apenas ir para o site" alt="Apenas ir para o site">  </a>   <a  style="color:#00C"  target="_blank" href="<?=$INI['system']['wwwprefix']?>/vipmin"> <img src="../skin/padrao/icones/paineladmin.png"   title="<?=utf8_decode("ir para a administração do site")?>" alt="<?=utf8_decode("ir para a administração do site")?>"></a>   <a   style="color:#00C" target="_blank" href="<?=$INI['system']['wwwprefix']?>/marketing">  <img src="../skin/padrao/icones/inter.png"  title="ir para o Interprise Email Marketing" alt="ir para o Interprise Email Marketing"> </a>
                     </div>
