						...
						<div id="container_box">
							<div id="option_contents" class="option_contents"> 
								<div class="form-contain group">
									<!-- =============================   coluna esquerda   =====================================-->
									<div class="starts">
										<div style="clear:both;"class="report-head">Youtube: <span class="cpanel-date-hint">Incluir endereço com http://</span></div>
										<div class="group">
											<input type="text" name="other[youtube]"  id="other[youtube]" class="format_input ckeditor" value="<?php echo $INI['other']['youtube']; ?>" />  <img style="cursor:help" class="tTip" title="Nome do seu perfil no Youtube " src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
									...
									<div class="ends">
										...
										<div class="group">
											<input type="text" name="other[orkut]"  id="other[orkut]" class="format_input ckeditor" value="<?php echo $INI['other']['orkut']; ?>" />  <img style="cursor:help" class="tTip" title="Endereço do seu perfil no Instagram " src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
									 </div>
									<!-- =============================  fim coluna direita  =====================================-->
								</div> 
								...
								<div class="form-contain group">
									...
									<div class="starts">								
										<div id="c_vendas">	
											...
											<div class="group">
												<input type="text" name="other[usuario_twitter]"  id="other[usuario_twitter]" class="format_input ckeditor" value="<?php echo $INI['other']['usuario_twitter']; ?>" />  <img style="cursor:help" class="tTip" title="Informe apenas o seu usuário do Twitter, para que o bloco Join Conversation seja exibido. Ex: <b>VipcomColetivas</b>Caso não tenha um usuário no Twitter crie um em criar um usuário" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
											</div> 	
											
											<div style="clear:both;"class="report-head">ID Twitter:  <span class="cpanel-date-hint">Ex: 345206136133263363</span> </div>
											<div class="group">
												<input type="text" name="other[id_twitter]"  id="other[id_twitter]" class="format_input ckeditor" value="<?php echo $INI['other']['id_twitter']; ?>" />    
											</div> 
