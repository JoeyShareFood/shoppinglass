        ...
        <div class="clear box"> 
            <div class="box-content">
                <div class="sect">
					...
					<input type="hidden" name="status" id="status" value="ativado" />
					<input type="hidden" name="create_time" id="create_time" value="<?=strtotime('+0 days')?>" />
					<input type="hidden" name="login_time" id="login_time" value="<?=strtotime('+0 days')?>" />
					<div class="option_box">
						<div class="top-heading group">
							<div class="left_float"><h4>Dados de Cadastro</h4></div>
								...
								<div class="form-contain group">
									...
									<div class="starts">   
										...
										<div class="group">
										 ...
										 <div style="clear:both;"class="report-head">Lojinha: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="login"    id="login" class="format_input ckeditor" value="<?php echo $user['login'] ?>" /> 
										</div>
									...
									<div class="ends"> 	 		 
										...
										<div style="clear:both;"class="report-head">Senha: <span class="cpanel-date-hint">Deixe em branco para não alterar</span></div>
										<div class="group">
										...
										<div class="group">
										 ...
										 <? if($user['manager'] =="Y" or $user['id'] =="1"){?>
						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group"> 
								...
								<div class="ends"> 	 		 
									...
									<div class="group">
									 		<select  style="height: 27px; width: 388px;" name="estado" id="estado" onchange="$('#select_estado').text($('#estado').find('option').filter(':selected').text())"> 
									...
									<div class="group">
										<input type="text" name="numero"  id="numero" class="format_input ckeditor" value="<?php echo $user['numero'] ?>" /> 
									</div> 
