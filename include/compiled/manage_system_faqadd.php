					...
					<div id="container_box">
						<div id="option_contents" class="option_contents"> 
							<div class="form-contain group">
									...
									<div class="option_box">
										...
										<div id="container_box">
											<div id="option_contents" class="option_contents">  
												<div class="form-contain group"> 
													<div class="text_area">  
													<textarea cols="45" rows="5" name="resposta" style="width:100%" id="resposta" class="format_input ckeditor" ><?php echo htmlspecialchars($n['resposta']); ?></textarea>
													</div> 
												</div> 
											</div> 
										</div>
								...
								<!-- =============================   coluna direita   =====================================-->
								<div class="ends"> 	 			 								 
									<div class="report-head">Ordenação da pergunta: <span class="cpanel-date-hint">Os maiores serão os primeiros</span></div>
									<div class="group">
										<input type="text" id="ordem"  onKeyPress="return SomenteNumero(event);"  name="ordem" value="<?php echo  $n['ordem'] ; ?>"> &nbsp; 
									</div>  
									<br />									
									<div class="report-head">Tipo:</div>
									<div class="group">
										<input type="radio" id="type" name="type" value="vende" <?php if($n['type'] == "vende") { ?>checked<?php } ?>> Para quem vende <br/>
										<input type="radio" id="type" name="type" value="compra" <?php if($n['type'] == "compra") { ?>checked<?php } ?>> Para quem compra
									</div>  
								 </div>
								<!-- =============================  fim coluna direita  =====================================-->
							</div> 
