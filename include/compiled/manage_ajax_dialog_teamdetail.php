<div id="order-pay-dialog" class="order-pay-dialog-c" style="width:765px;">
	...
	<table width="96%" align="center" class="coupons-table">
		...
		<tr><td><b>Preço:</b></td><td>Preço de mercado: <?=$currency?> <b><?php echo moneyit3($team['market_price']); ?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Preço do item: <?=$currency?> <b><?php echo moneyit3($team['team_price']); ?></b>&nbsp;</td></tr>
