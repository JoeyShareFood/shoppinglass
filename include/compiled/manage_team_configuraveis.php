				...
				<div class="option_box">
					<div class="top-heading group"> 
						<div class="left_float">
							<h4>   Ofertas Configuráveis <img style="cursor:help" class="tTip" title="Com ofertas configuráveis, você pode criar ofertas como essa: 3, 5 ou 10 sessões de secagem de peeling com luz pulsada intensa, a partir de <?=$currency?> 49,90." src="<?=$ROOTPATH?>/media/css/i/info.png">  </h4> 
