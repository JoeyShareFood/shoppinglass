	...
	<div id="content" class="clear mainwide">
        <div class="clear box"> 
            <div class="box-content">
                <div class="sect">
				<form id="nform" id="nform"  method="post" action="/adminanunciante/team/atributos.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
...
function verlayout(){ 
   if(jQuery("#posicionamento").val() == "6"){ // posicionalmento 6 = super banner
	   ...
	   $.get(WEB_ROOT+"/adminanunciante/funcoes.php?acao=destaque",
	   ...
	   $.get(WEB_ROOT+"/adminanunciante/funcoes.php?acao=destaquenacional",
