            ...
            <div class="box-content">
				...
				<div class="option_box">
					<div class="top-heading group">
						<div class="left_float"><h4>Informações gerais do anúncio <?=$team['id']?></h4></div>
							<div class="the-button" style="width:270px;"> 
								...
								<!--<div style="float:left;"><button onclick="doupdate('cadastraratributos');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"><img name="imgrec" id="imgrec" src="<?=$ROOTPATH?>/media/css/i/lendo.gif" style="display: none;"></div><div id="spinner-text"  >Salvar e cadastrar atributos</div></button></div>-->
								 <div style="float:left;"><button  onclick="javascript:location.href='index.php'"  id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"><img name="imgrec" id="imgrec" src="<?=$ROOTPATH?>/media/css/i/lendo.gif" style="display: none;"></div><div id="spinner-text"  >Cancelar</div></button></div>
							</div> 
					</div> 
						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div style="clear:both;"class="report-head">Título do anúncio: <span class="cpanel-date-hint"></span></div>
									<div class="group">
										<input type="text" name="title"  maxlength="172" id="title" class="format_input ckeditor" value="<?php echo htmlspecialchars($team['title']); ?>" />  <img style="cursor:help" class="tTip" title="Tenha certeza que este campo irá conter as principais palavras chaves deste produto. Não se esqueça que estas mesmas palavras devem estar no campo descrição de produto para otimizar ainda mais as buscas." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
									</div>  
									<div style="clear:both;"class="report-head">Título do anúncio resumido até 50 caracteres: <span class="cpanel-date-hint"> </span></div>
									<div class="group">
										<input type="text" name="titleresumido"  maxlength="50" id="titleresumido" class="format_input ckeditor" value="<?php echo htmlspecialchars($team['titleresumido']); ?>" />  
									</div>   
									...
									<div id="c_categoria">
										...
										<script>
											...
											<div class="cjt-wrapped-select-icon"></div>
											</div> &nbsp;<img class="tTip" title="Você pode escolher uma categoria para este produto. Isso ajuda os usuários a encontrar mais facilmente um produto." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">
										</div>   
									</div> 
									<!--
									...
									<div class="group">
										...
										<div name="select_buyonce" id="select_buyonce" class="cjt-wrapped-select-skin">Informe a condição deste produto</div>
										<div class="cjt-wrapped-select-icon"></div>
										</div> &nbsp;<img class="tTip" title="Informe a condição que melhor se adeque a este produto. " style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">
									</div>  
									-->
									<div id="url_botao_comprar">									
										...
										<div class="group">
											<input type="text" id="codreferencia" name="codreferencia" value="<?php echo  $team['codreferencia'] ; ?>"> 
										</div>	
									</div>
									<div class="report-head" style="margin-top:5px;">Moderação: <span class="cpanel-date-hint"></span></div>
									<div class="group">
										<input type="radio" name="moderacao" value="Y" <?php if($team['moderacao'] == "Y"){ ?> checked="checked" <?php } ?>>&nbsp; Publicar&nbsp; <img class="tTip" title="Esta opção irá moderar e publicar o anúncio. Com isso o mesmo irá ser exibido no site." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										<input type="radio" name="moderacao" value="N" <?php if($team['moderacao'] == "N" || $team['moderacao'] == ""){ ?> checked="checked" <?php } ?>>&nbsp; Não publicar
									</div>	
								...
								<div class="ends"> 
									...
									<div id="c_posicionamento">
										<div class="report-head">Posicionamento : <span class="cpanel-date-hint">Selecione os 20 melhores anúncios para a HOME &nbsp;<img class="tTip" title="Não coloque todos os anúncios na Vitrine. Sugerimos 20 anúncios em destaque" style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"> </span></div>
										<div class="cjt-wrapped-select" id="type-select-cjt-wrapped-select">
											<select  name="posicionamento" id="posicionamento" onchange="$('#select_posicionamento').text($('#posicionamento').find('option').filter(':selected').text()); "> 
												<option value="12" >Posicionamento</option>
												<option value="0" <?php if($team['posicionamento'] == 0){ echo "selected"; } ?> >Destaque na Página Principal</option>
												<option value="12" <?php if($team['posicionamento'] == 12){ echo "selected"; } ?>  >Não é Destaque</option>
												<option value="5" <?php if($team['posicionamento'] == 5){ echo "selected"; } ?>  >Oferta Desativada</option>
											</select>
											<div name="select_posicionamento" id="select_posicionamento" class="cjt-wrapped-select-skin">Informe a posição deste anúncio</div>
											<div class="cjt-wrapped-select-icon"></div>
										</div>  
									</div>									
									<div id="parceirobk">
										<div class="report-head">Usuário : <span class="cpanel-date-hint">Opcional</span></div>
										<div class="cjt-wrapped-select" id="type-select-cjt-wrapped-select">
											<select  name="partner_id" id="partner_id" onchange="$('#select_partner_id').text($('#partner_id').find('option').filter(':selected').text())"> 
												<option value="">Informe o usuário deste anúncio</option>
												<?php
													$SqlUser = "select id, realname from user";	
													$SqlQuery = mysql_query($SqlUser);
													
													while($SqlFetch = mysql_fetch_assoc($SqlQuery)) {
														
												?>
												<?php if($SqlFetch['id'] == $team['partner_id']) { ?><option selected="selected" value="<?php echo $SqlFetch['id']; ?>"><?php echo $SqlFetch['realname']; ?></option><?php } ?>
												<?php if($SqlFetch['id'] != $team['partner_id']) { ?><option value="<?php echo $SqlFetch['id']; ?>"><?php echo $SqlFetch['realname']; ?></option><?php } ?>
												<?php
													}
																								
												?>
											</select>
											<div name="select_partner_id" id="select_partner_id" class="cjt-wrapped-select-skin">Informe o usuário deste anúncio</div>
											<div class="cjt-wrapped-select-icon"></div>
										</div> &nbsp;<img class="tTip" title="Usuário responsável pelo anúncio." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">
									</div> 								
				...
				<div class="option_box">
					<div class="top-heading group">
						<div class="left_float"><h4>Opções</h4></div>
					</div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
									...
									<div id="c_vendas" class="option_<?php echo $option['id']; ?>_content">	 
										<div id="c_estoque" class="c_estoque_add">
											...
											<div id="stock_content">
												...
												<div class="group">
													<input type="text" name="stock[]"  onKeyPress="return SomenteNumero(event);"  id="stock" class="format_input ckeditor"  value="<?php echo $option['stock']; ?>" maxlength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade em estoque." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
											<div id="size_content">
												<div style="clear:both;"class="report-head">Tamanho: <span class="cpanel-date-hint"></span></div>
												<div class="group">
													<input type="text" name="size[]" id="size" maxlength="2" class="format_input ckeditor"  value="<?php echo $option['size']; ?>" >  <img style="cursor:help" class="tTip" title="Tamanho do produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
											<div id="color_content">
												<div style="clear:both;"class="report-head">Cor: <span class="cpanel-date-hint"></span></div>
												<div class="group">
													<input type="text" name="color[]" id="color" maxlength="100" class="format_input ckeditor"  value="<?php echo $option['color']; ?>">  <img style="cursor:help" class="tTip" title="Cor do produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
									...
									<div id="c_vendas">	 
										<div id="c_estoque" class="c_estoque_add">
											<div id="stock_content">
												<div style="clear:both;"class="report-head">Estoque: <span class="cpanel-date-hint"></span></div>
												<div class="group">
													<input type="text" name="stock[]"  onKeyPress="return SomenteNumero(event);"  id="stock" class="format_input ckeditor" maxlength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade em estoque." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
											<div id="size_content">
												<div style="clear:both;"class="report-head">Tamanho: <span class="cpanel-date-hint"></span></div>
												<div class="group">
													<input type="text" name="size[]" id="size" maxlength="2" class="format_input ckeditor">  <img style="cursor:help" class="tTip" title="Tamanho do produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
											<div id="color_content">
												<div style="clear:both;"class="report-head">Cor: <span class="cpanel-date-hint"></span></div>
												<div class="group">
													<input type="text" name="color[]" id="color" maxlength="100" class="format_input ckeditor">  <img style="cursor:help" class="tTip" title="Cor do produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
												</div> 
											</div> 
										</div> 
									</div>									
								...
								<div class="ends"> 
									<div class="input_fields_wrap">
										<button class="add_field_button">Adicione mais opções</button>
									</div>								
								</div>
							</div>
							<!-- ============================= // fim coluna direita // =====================================-->
				...
				<div class="option_box">
					<div class="top-heading group">
						<div class="left_float"><h4>Controle</h4></div>
					</div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									<div id="c_vendas">	 
										...
										<div class="group">
											<input type="text" name="minimo_pessoa"  onKeyPress="return SomenteNumero(event);"   id="minimo_pessoa" class="format_input ckeditor"  value="<?php echo intval($team['minimo_pessoa']); ?>" maxLength="6"  />  <img style="cursor:help" class="tTip" title="Quantidade mínima para finalizar o pedido. Ex: Para comprar este produto, o cliente deverá comprar 5 unidades ou mais." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
								...
								<div class="ends"> 
										...
										<div class="report-head">Ativar avaliação de clientes<span class="cpanel-date-hint"></span></div> 
										<input style="width:20px;" type="radio" <? if($team['avaliacaoclientes']=="1" or $team['avaliacaoclientes']==""){ echo "checked=checked"; }?> value="1" name="avaliacaoclientes"> Sim   &nbsp;<img class="tTip" title="Se ativado, o site irá enviar um email para os compradores 15 dias após a aprovação da compra para darem a sua opinião sobre o produto. Esta opinião irá aparecer no detalhe do produto na aba Avaliação dos clientes." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">    
										<input style="width:20px;" type="radio" <? if($team['avaliacaoclientes']=="0" ){ echo "checked=checked"; }?> value="0" name="avaliacaoclientes"> Não
										
										<div class="report-head">Ativar perguntas para este anúncio<span class="cpanel-date-hint"></span></div> 
										<input style="width:20px;" type="radio" <? if($team['answer']=="Y"){ echo "checked=checked"; }?> value="Y" name="answer"> Sim   &nbsp;<img class="tTip" title="Se ativado, na página do anúncio será possível criar perguntas para o vendedor." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">    
										<input style="width:20px;" type="radio" <? if($team['answer']=="N" or  $team['answer']==""){ echo "checked=checked"; }?> value="N" name="answer"> Não
				...
				<div class="option_box" id="abapagamento">
					<div class="top-heading group">
						<div class="left_float"><h4>Informações de Preço e Pagamento</h4></div>
					</div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">   
									<div id="c_valores">
										...
										<div class="group">
											<input type="text" name="market_price"   id="market_price" class="format_input ckeditor"   value="<?php echo $team['market_price'] ; ?>" />  <img style="cursor:help" class="tTip" title="Valor antigo do produto." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Por: <span class="cpanel-date-hint"></span></div>
										<div class="group">
											<input type="text" name="team_price"  id="team_price"  class="format_input ckeditor"   value="<?php echo  $team['team_price'] ; ?>"  />  <img style="cursor:help" class="tTip" title="Valor atual do produto" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 	
									</div> 
								</div>
								<!-- ============================= // fim coluna esquerda // =====================================-->
				 ...
				 <!-- ********************************************* ABA Fotos --> 
				<div class="option_box">
					<div class="top-heading group"> <div class="left_float"><h4>Imagens do Produto </h4> </div> </div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								<!-- =============================   coluna esquerda   =====================================-->
				...
				<div class="option_box" id="c_estaticas" style="display:none;">
					<div class="top-heading group"> <div class="left_float"><h4>Imagens Estáticas (  Opcional )</h4> </div> </div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								<!-- =============================   coluna esquerda   =====================================-->
							...
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group">
									...
									<div class="starts">
										...
										<div class="group">
											<input type="text" name="ceporigem"  maxlength="8" onKeyPress="return SomenteNumero(event);" id="ceporigem" class="format_input ckeditor" value="<?php echo  $team['ceporigem'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no cep de origem. Ou seja, o cep de onde este produto está sendo enviado." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Peso: <span class="cpanel-date-hint">2 (significa 2 kilos), 0.2  (significa 200 gramas)</span></div>
										<div class="group">
											<input type="text" name="peso"  maxlength="162"   id="peso" class="format_input ckeditor" value="<?php echo  $team['peso'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no peso deste produto. Ex: 2 (significa 2 kilos), 0.2  (significa 2 gramas)" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Altura: <span class="cpanel-date-hint">A altura nao pode ser inferior a 2 cm</span></div>
										<div class="group">
											<input type="text" name="altura"  maxlength="162"  id="altura" class="format_input ckeditor" value="<?php echo  $team['altura'] ; ?>" />  <img style="cursor:help" class="tTip" title=" O valor do frete será calculado baseado na altura deste produto. Ex: 2" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>
									...
									<div class="ends">
										...
										<div style="clear:both;"class="report-head">Largura: <span class="cpanel-date-hint">A largura nao pode ser inferior a 11 cm</span></div>
										<div class="group">
											<input type="text" name="largura"  maxlength="162"  id="largura" class="format_input ckeditor" value="<?php echo  $team['largura'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado na largura deste produto. Ex: 11" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div> 
										<div style="clear:both;"class="report-head">Comprimento: <span class="cpanel-date-hint">O comprimento nao pode ser inferior a 16 cm</span></div>
										<div class="group">
											<input type="text" name="comprimento"   maxlength="162" id="comprimento" class="format_input ckeditor" value="<?php echo  $team['comprimento'] ; ?>" />  <img style="cursor:help" class="tTip" title="O valor do frete será calculado baseado no comprimento deste produto. Ex: 16" src="<?=$ROOTPATH?>/media/css/i/info.png"> 
										</div>	
										...
										<div style="float:left; width:100%; margin-top: 15px;margin-bottom:11px;">
										   <span class="report-label">Retirada no local:</span>  
											...
											<!--<input style="width:20px;" type="radio"  <?php if($team['retirada_local'] == 0) {?>checked<?php } ?>  value="0" id="retirada_local"  name="retirada_local" > Desativado  &nbsp; -->
										</div> 
					...
					<div class="option_box">
						<div class="top-heading group"> <div class="left_float"><h4>Permissão de aceite</h4>   </div>  </div> 
						 
						<div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									<textarea cols="45" rows="5" name="termosdeuso" style="width:100%" id="termosdeuso" class="format_input ckeditor" ><?php echo htmlspecialchars($team['termosdeuso']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
					...
					<!-- ********************************************* ABA Descrição da oferta --> 
					<div class="option_box">
						<div class="top-heading group"> <div class="left_float"><h4>Aba - Informações do Produto</h4>  <button onclick="gera_tabela_caracteristicas('summary');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"> </div><div id="spinner-text"  >Gerar tabela de características</div></button>  </div>  </div> 
					...
					<div class="option_box">
						<div class="top-heading group" style="width: 37%;"> <div class="left_float"><h4>Nova Aba - OPCIONAL</h4> <button onclick="gera_tabela_caracteristicas('notice');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"> </div><div id="spinner-text"  >Gerar tabela de características</div></button>  </div> 
							<div class="pcu">
								<span class="cpanel-date-hint"  style="margin-right: 5px; color:#303030;">Nome da Aba </span> <input  style="width: 300px; height: 25px;" type="text" name="nomeaba1"  maxlength="23" id="nomeaba1" class="format_input ckeditor" value="<?php echo  $team['nomeaba1'] ; ?>" />  <img style="cursor:help" class="tTip" title="Informe o nome desta aba. Máximo de 23 caracteres, contudo fique atento para o tamanho de cada aba para não prejudicar o layout.  Deixe em branco para não aparecer." src="<?=$ROOTPATH?>/media/css/i/info.png"> 
							</div>	
						</div> 
					...
					<div class="option_box">  
						<div class="top-heading group" style="width: 37%;"> <div class="left_float"><h4>Nova Aba - OPCIONAL</h4> <button onclick="gera_tabela_caracteristicas('detail');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"> </div><div id="spinner-text"  >Gerar tabela de características</div></button> </div>  
							<div class="pcu">
								<span class="cpanel-date-hint"  style="margin-right: 5px; color:#303030;">Nome da Aba </span> <input  style="width: 300px; height: 25px;" type="text" name="nomeaba2"  maxlength="23" id="nomeaba2" class="format_input ckeditor" value="<?php echo  $team['nomeaba2'] ; ?>" />  
							</div>	
						</div> 
					...
					<div class="option_box"  style="display:none;" id="maisinfo">
						<div class="top-heading group"> <div class="left_float"><h4>Mais informações na tela de pagamento</h4> </div>   </div> 
					...
					<div class="option_box">  
						<div class="top-heading group"> <div class="left_float"><h4>Condições de Envio (opcional) </h4>  <button onclick="gera_tabela_caracteristicas('condicaoenvio');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"> </div><div id="spinner-text"  >Gerar tabela de características</div></button> </div> </div> 						 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									 <textarea cols="45" rows="5" name="condicaoenvio" style="width:100%" id="condicaoenvio" class="format_input ckeditor" ><?php echo htmlspecialchars($team['condicaoenvio']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
					...
					<div class="option_box">  
						<div class="top-heading group"> <div class="left_float"><h4>Garantia (opcional) </h4>  <button onclick="gera_tabela_caracteristicas('garantia');" id="run-button" class="input-btn" type="button"><div name="spinner-top" id="spinner-top" style="width: 83px; display: block;"> </div><div id="spinner-text"  >Gerar tabela de características</div></button> </div> 
						 
						 	<div class="pcu">
								<span class="cpanel-date-hint"  style="margin-right: 5px; color:#303030;">Nome da Aba </span> <input  style="width: 300px; height: 25px;" type="text" name="nomeaba5"  maxlength="23" id="nomeaba5" class="format_input ckeditor" value="<?php echo  $team['nomeaba5'] ; ?>" />  
							</div>	
						 ...
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
									 <textarea cols="45" rows="5" name="garantia" style="width:100%" id="garantia" class="format_input ckeditor" ><?php echo htmlspecialchars($team['garantia']); ?></textarea>
									</div> 
								</div> 
							</div> 
						</div>
					...
					<div  id="infopagamento"  class="option_box">  
						<div class="top-heading group"> <div class="left_float"><h4>Auto Relacionamento de Produtos - Produtos Similares</h4> </div> </div> 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
								<div class="report-head">Palavra chave: <span class="cpanel-date-hint">Informe as palavras chaves separadas por virgula. Ex: secador, chapinha, prancha.   ATENÇÃO: <b> Não informe palavras compostas.</b> Ex: televisão de LCD <b>(errado)</b>, LCD (certo), televisão (certo).</span></div>
									<div class="group">
										<input type="text" id="seo_keyword" name="seo_keyword" value="<?php echo  $team['seo_keyword'] ; ?>"> &nbsp;<img class="tTip" title="O sistema irá buscar todos os produtos que contenham esta mesma palavra chave e listá-los em produtos relacionados na página de detalhes deste produto. Não informe palavras compostas. Ex: televisão de LCD (errado), LCD (certo), televisão (certo)." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png">
									</div>	
								</div> 
							</div> 
						</div>
...
function validador(){
   ...
   if( jQuery("#group_id").val()==""){
	...
	if(partner_id == ""){
		alert("Por favor informe o usuário dono da oferta.");
