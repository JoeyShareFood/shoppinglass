							...
							<div id="container_box">
								<div id="option_contents" class="option_contents"> 
									...
									<div class="form-contain group">
										<!-- =============================   coluna esquerda   =====================================-->
										<div class="starts">
				Ainda não tem a sua logomarca ? <a target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/criacao-de-logotipos">Veja nossos planos</a> de criação de logomarca profissional e de alta qualidade
				
											<div style="clear:both;"class="report-head">Logo: <span class="cpanel-date-hint"></span></div>
											<div class="group">
												<img style="max-height:350px;max-width:470px;" src="<?= $ROOTPATH ?>/include/logo/logo.png"   />
												...
												<form name="img1" action="<?php echo $INI['system']['wwwprefix'] ?>/include/upload.php?nome=logo&width=300&height=98" target="upload_target" method="post" enctype="multipart/form-data"   onsubmit="startUpload();" >
													...
													<div class="field" style="width: 550px;">
														...
														<span class="inputtip">Resolução ideal (248px x 88px) ou Largura máxima: 270px e Altura máxima: 94px - 
														<br>Após enviar aperte CTRL+F5 para remover o cache do navegador
														</span>
													</div>
										...
										<!-- =============================   coluna direita   =====================================-->
										<div class="ends">
											<div style="clear:both;"class="report-head">Favicon <span class="cpanel-date-hint"></span></div>
											<div class="group">
												<img style="max-width: 100px;" src="<?= $PATHSKIN ?>/images/favicon.ico" />
												<form name="img2" action="<?php echo $INI['system']['wwwprefix'] ?>/include/upload.php?nome=favicon&width=724&height=266"  target="upload_target"  method="post" enctype="multipart/form-data"   onsubmit="startUpload();" >
													<h3>Arquivo</h3>

													<div class="field" style="width: 550px;">
														<input name="myfile" type="file" />
														<input type="submit" name="submitBtn"  class="formbutton" value="Upload" />
														<span class="inputtip">Resolução obrigatória (16px x 16px) EXTENÇÃO .ico <br>
														<a target="_blank" href="http://favicon-generator.org/">Clique aqui</a> para gerar o seu favicon <br>
														Após enviar aperte CTRL+F5 para remover o cache do navegador
														</span>
													</div>
													<input type="hidden" value="<?php echo $INI['system']['wwwprefix'] ?>" id="local" name="local">
													<iframe id="upload_target" name="upload_target" src="#" style="width:0;height:0;border:0px solid #fff;"></iframe>                 
