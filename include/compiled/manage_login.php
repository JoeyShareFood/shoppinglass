        ...
        <div id="login-container">
            <div id="login-sub-container">
				...
				<? if($INI['option']['auth_setup']!="N"){?>
                    <img style="width: 200px;" src="/include/logo/logo.png" alt="logo">
				<? } 
				else{?>
...
<script>
    ...
    delete MESSAGES[""];
   	...
   	<? if($INI['option']['auth_setup']!="N"){?> <div class="copyright">O Vipmin foi projetado para navegadores Firefox e Google Chrome</div> <? } ?>
