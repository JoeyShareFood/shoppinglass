        ...
        <div class="clear box"> 
            <div class="box-content">
				...
				<div class="option_box">
				 ...
				 <div class="left_float"><h4>Slideshow de Banners - Resolução: 1200px de largura x 370px de altura ( jpg, png )</h4></div> 
				...
				<!-- 
					...
					-->
					<input type="hidden"  value="Y" name="slideshowbanners[ativo]"> 
