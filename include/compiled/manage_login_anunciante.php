            ...
            <div class="col-md-4 col-md-offset-4 col-xs-12 col-sm-12">
                ...
                <div id="login-sub">
					<form id="login_form_admin" action="loginpos.php" method="post" target="_top">
						<div class="input-req-login text-left"><label for="user">Email</label></div>
						<div class="input-field-login icon username-container text-left">
							<input name="username" id="username" autofocus="autofocus" value="" placeholder="Email de acesso" class="form-control" tabindex="1" required="" type="text" class="form-control ckeditor">
						</div>
						<div style="margin-top:30px;" class="input-req-login text-left"><label for="pass">Senha</label></div>
						<div class="input-field-login icon password-container text-left">
							<input name="password" id="password" placeholder="Senha de acesso" class="form-control" tabindex="2" required="" type="password" onkeypress="CheckEnter_admin(event);" class="form-control ckeditor">
						</div>
						<div class="login-btn">
...
<script>
    ...
    delete MESSAGES[""];
   	...
   	<? if($INI['option']['auth_setup']!="N"){?> <div class="copyright hide">Esta �rea � melhor visualizada em navegadores Firefox e Google Chrome</div> <? } ?>
