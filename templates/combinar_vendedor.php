<?php 
	...
	$proposta = strip_tags($_REQUEST['proposta']);
												...
												<tbody>
													<tr style="font-size: 14px;   color: #303030; padding: 2px 0px; margin: 0px; font-family: 'Verdana';">
														<td style="padding: 4px;border:1px solid #DCDCDC;" valign="top" width="57%">
															...
															<div class="titulo" style="background:#20547E; box-shadow: 2px 2px 4px 0 #888888;font-family: helvetica;font-size: 19px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;">Combinar com vendedor</div> 
															<p>Utilize os dados abaixo para entrar em contato com o seu cliente.</p>
															<BR><b>Pedido: </b>#<?=$idpedido?>
															<BR><b>Nome: </b><?=$nome?>
															<BR><b>Email: </b><?=$email?>
															<BR><b>Telefone: </b><?=$telefone?>										 
															<BR><b>Mensagem: </b><?=$proposta?>										 								 
															<p><b><?=$nomesite ?></b></p> 
														</td>
