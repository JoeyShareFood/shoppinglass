...
<div class="titulo" style="background:#20547E; box-shadow: 2px 2px 4px 0 #888888;font-family: helvetica;font-size: 19px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;">Uma nova pergunta foi enviada!</div> 

 

 <p>Para moderar esta pergunta, clique <a href="<?php echo $ROOTPATH; ?>/vipmin/user/question.php">aqui</a>.</p>

 <?php if(!(empty($team['title']))) { ?><BR><b>Anúncio: </b><a href="<?php echo $ROOTPATH; ?>/index.php?idoferta=<?php echo $team['id']; ?>"><?=$team['title']?></a><?php } ?>
 <BR><b>Título: </b><?=$questions['titulo']?>
