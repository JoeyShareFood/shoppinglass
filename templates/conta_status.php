 <?php 
	...
	if(isset($_REQUEST["id_user"])) {
		...
		$id = (int) strip_tags(trim($_GET["id_user"]));
...
<div class="titulo" style="background:#20547E; box-shadow: 2px 2px 4px 0 #888888;font-family: helvetica;font-size: 19px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;">Conta de login</div> 
 <p>Olá <?php echo $user['login']; ?>,</p>
 <?php if($user['status'] == "ativado") { ?>
 
 <p><img src="<?php echo $PATHSKIN; ?>/images/correct.png">Sua conta foi reativada com sucesso. Com isso será possível aproveitar todas as novidades e ofertas do site. <br /><br /> Boas compras!</p>
 
 <?php } ?>
 
 <?php if($user['status'] == "desativado") { ?>

<p><img src="<?php echo $PATHSKIN; ?>/images/cancelled.png"> Sua conta foi desativada temporariamente. Para mais informações, entre em contato no email abaixo. <br /><br /> Email:<?php echo $INI['mail']['helpemail']; ?></p>
