 <?php 
	...
	$nome = strip_tags($_REQUEST["realname"]);
...
<div class="titulo" style="background:#20547E; box-shadow: 2px 2px 4px 0 #888888;font-family: helvetica;font-size: 19px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;">Lembrete de fatura em aberto</div> 
...
<p><img style="max-width:28px;" src="<?php echo $PATHSKIN; ?>/images/cancelled.png"> Este é apenas um lembrete para lhe informar que você possui fatura(s) em aberto em sua conta. </p>
<p>Você pode acessar a sua área de cliente para visualizar e pagar a fatura em <a href="<?=$ROOTPATH; ?>/faturas"> <?=$ROOTPATH?>/faturas </a>  </p>
