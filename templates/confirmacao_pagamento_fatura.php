...
<div class="titulo" style="background:#20547E; box-shadow: 2px 2px 4px 0 #888888;font-family: helvetica;font-size: 19px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;">Pagamento de fatura</div> 

 <p>A fatura #<?php echo $id; ?> foi paga via PagSeguro com sucesso.</p>
 
 <p>Login do usuário: <?php echo $user['login']; ?></p>
 <p>Forma de pagamento: PagSeguro</p>
 <p>Valor: R$ <?php echo number_format($faturas['valor'], 2, ",", "."); ?></p>
 <p>Data de geração: <?php echo date("d/m/Y H:i:s", strtotime($faturas['data_geracao'])); ?></p>
 <p>Data de pagamento: <?php echo date("d/m/Y H:i:s", strtotime($faturas['data_pagamento'])); ?></p>
