 J(document).ready(function(){
  ...
  J("#paging_button li").click(function(){
    ...
    J("#pgofertas").load(URLWEB+"/include/paginacao_post.php?idcategoria="+ID_CATEGORIA+"&page=" + this.id, hideLoader);
  ...
  J("#pgofertas").load(URLWEB+"/include/paginacao_post.php?idcategoria="+ID_CATEGORIA+"&page=1", hideLoader);
