...
(function( j203, window, document, undefined ) {
	...
	var Carousel = {
		...
		setVars : function(){
			...
			base.baseClass();
			base.eventTypes();
			base.j203userItems = base.j203elem.children(":not('script')");
...
wm.carouselTvHome = (function(){
  "use strict";

  var carouselElem = j203(".tv-home .owl-carousel");
...
wm.carouselTvHome.init();
wm.carouselBannerHome = (function() {
  "use strict";

  var carouselElem = j203(".carousel-banners-home .owl-carousel");
...
wm.carouselBannerHome.init();
wm.carouselHome = (function(){
  "use strict";

  var carouselElem = j203(".carousel-shelf-home");

  function activateCarousel(el) {
    j203(el).owlCarousel({
      items: 3,
      slideSpeed: 700,
      navigation : true,
  ...
  return {
    init: function() {
      ...
      //lazy.init(carouselElem, activateCarousel);
    }
  };

})();

wm.carouselHome.init();
wm.menuShelf = (function() {
  "use strict";

  var component = j203(".main-content"),
      items = component.find(".home-list"),
      shelf = component.find(".shelf-item"),
      title = component.find(".menu-title-link"),
      menu = component.find(".menu-left-link");
  ...
  function deactivateShelf() {
    shelf.removeClass("active");
  }

  function activateShelf(target) {
