 J(document).ready(function(){
  ...
  J("#paging_button li").click(function(){
    ...
    J("#pgofertas").load(URLWEB+"/include/paginacao_parceiro.php?idparceiro="+ID_PARCEIRO+"&page=" + this.id, hideLoader);
  ...
  J("#pgofertas").load(URLWEB+"/include/paginacao_parceiro.php?idparceiro="+ID_PARCEIRO+"&page=1", hideLoader);
