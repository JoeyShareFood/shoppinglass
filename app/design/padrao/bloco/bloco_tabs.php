...
<div style="display:none;" class="tips"><?=__FILE__?></div>
	<div id="tabs">
		<ul>
			...
			<? if($team['nomeaba1'] != ""){?><li><a  href="#tabs-6"><?php echo utf8_decode($team['nomeaba1']); ?></a></li><? } ?>
			<? if($team['nomeaba2'] != ""){?><li><a  href="#tabs-7"><?php echo utf8_decode($team['nomeaba2']); ?></a></li><? } ?>
		</ul>
		...
		<? if($team['nomeaba1'] != ""){?>
			<div id="tabs-6" >
				<? require_once(DIR_BLOCO."/bloco_aba1.php");  ?>
			</div>	
		<? } ?> 
		<? if($team['nomeaba2'] != ""){?>
			<div id="tabs-7" >
				<? require_once(DIR_BLOCO."/bloco_aba2.php");  ?>
			</div>	
		<? } ?> 		 
	</div> 					
</div>  
