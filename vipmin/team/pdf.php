...
class VipPDF extends TCPDF{
	...
	public function Header(){
		...
		$this->MultiCell(0, 4, ' Relatório de Ofertas Cadastradas', 0, 'C', false, 1);
		...
		$this->MultiCell(30, 4, 'Categoria', 1, 'C', false, 0);
		...
		$this->MultiCell(15, 4, 'Vendidos', 1, 'C', false, 0);
		...
		$this->MultiCell(20, 4, 'Refer.', 1, 'C', false, 0);
		#$this->line(275, PDF_MARGIN_TOP-15, 275, $this->GetPageHeight() - $pageH);
...
$pdf->SetTitle('Relatório de Ofertas Cadastradas');
...
while ($reg = mysql_fetch_array($resultado)) {
	...
	$pdf->MultiCell(30, $h, utf8_encode($reg['categoria']), 0, 'C', false, 0);
...
$pdf->Output('relatorio_ofertas_'.date("dmYHis").'.pdf', 'I');